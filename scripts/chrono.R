...
## A <- matrix(scan("../output/chrono_596x265.csv", n = 3 * count, sep = ','), count, 3)
A <- matrix(scan("../output/chrono_217x137.csv", n = 3 * count, sep = ','), count, 3)

A <- t(A)

plot(A[1,], type="l", col="blue", ylim=c(0, 255), xlab="Image no.", ylab="Intensite", main="Chronogramme du pixel [10,10]")
